...
bool LASO::HS022::objFun(double *x, double *fObj)
{

	fObj[0] = pow((x[0] - 2.0), 2.0) + pow((x[1] - 1.0), 2.0);

	return true;

}

bool LASO::HS022::objGrad(double *x, double *gObj)
{
...
bool LASO::HS022::conFun(double *x, double *fCon)
{
...
bool LASO::HS022::conJac(double *x, double *jCon)
{
